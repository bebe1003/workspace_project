	...
	<div class="row align-items-md-stretch text-center">
		<div class="row justify-content-center align-items-center">
			<div class="h-100 p-5 col-md-6">
				...
				<form class="form-signin" action="j_security_check" method="POST" name="form">
					<div class="form-floating mb-3 row">
						<input type="text" class="form-control"  placeholder="아이디를 입력해주세요." name="j_username" autocomplete="on" required autofocus/>
